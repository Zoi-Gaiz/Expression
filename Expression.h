//
// Created by 剑伊 on 2021/6/10.
//

#ifndef STACKLAB_EXPRESSION_H
#define STACKLAB_EXPRESSION_H
...
typedef struct {
    ...
    wchar_t top;
    int charsize;
}charSqStack,*charStack;

typedef struct {
    wstring base;
    wstring top;
    int stringsize;
}stringSqStack,*stringStack;
